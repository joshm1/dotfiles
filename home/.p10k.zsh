# Generated by Powerlevel10k configuration wizard on 2022-02-02 at 15:21 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # pyenv                   # python environment (https://github.com/pyenv/pyenv) - using asdf instead
    goenv                   # go environment (https://github.com/syndbg/goenv)
    # nodenv                  # node.js version from nodenv (https://github.com/nodenv/nodenv)
    # nvm                     # node.js version from nvm (https://github.com/nvm-sh/nvm) - using asdf instead
